...
package net.learning.jvmperformance.batching.stock;
...
public class StockPriceUtils {
    ...
    public static String getStockCode(int symbolNumber) {
    ...
    public static String getRandomSymbol() {
        return getStockCode(ThreadLocalRandom.current().nextInt(NSYMBOLS));
    }
}
